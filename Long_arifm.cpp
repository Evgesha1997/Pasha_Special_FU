...
//}
//
//void big_integer::extract(string& str) {
//    int idx = 0;
//    string rez = "";
//    if (str[idx] != '0')
...
//        this->_is_negative = false;
//
//        for (long long i = rez.length(); i > 0; i -= 9) {
//            if (i < 9)
//                this->_digits.push_back(atoi(rez.substr(0, i).c_str()));
//            else
//                this->_digits.push_back(atoi(rez.substr(i - 9, 9).c_str()));
//        }
//
//        this->_remove_leading_zeros();
//    }
